...
print(choices(outcomes, k=10)) # Result: ['play again', 'lose', 'win', 'play again', 'play again', 'double win', 'draw', 'win', 'double win', 'double win']
...
print(outcomes) # Result: ['lose', 'play again', 'win', 'double win', 'draw']

print(choices(outcomes, k=5)) # Result: ['double win', 'double win', 'double win', 'double win', 'win']

# Without duplicates:
print(sample(outcomes, k=5)) # Result: ['draw', 'play again', 'double win', 'win', 'lose']

print(sample(range(1, 57), k=6)) # Result: [39, 22, 45, 42, 8, 54]

print(sorted(sample(range(1, 57), k=6))) # Result: [19, 23, 29, 40, 42, 46]
...
print(choice(population)) # Result: white

print([choice(population) for i in range(6)]) # Result: ['white', 'green', 'white', 'red', 'white', 'red']
...
# ['tens', 'tens', 'tens', 'tens', 'tens', 'tens', 'tens', 'tens', 'tens', 'tens', 'tens', 'tens', 'tens', 'tens', 'tens', 'tens', 'low', 
